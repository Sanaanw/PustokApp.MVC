...
namespace PustokApp.Migrations
{
    ...
    [Migration("20250423101729_AddingOrderMig")]
    partial class AddingOrderMig
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PustokApp.Models.Home.Order", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("PustokApp.Models.Home.OrderItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("PustokApp.Models.Home.OrderItem", b =>
                {
                    ...
                    b.HasOne("PustokApp.Models.Home.Order", "Order")
                        .WithMany("OrderItems")
